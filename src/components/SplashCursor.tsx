...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function correctDeltaX(delta: number) { let ar = canvas.width / canvas.height; if (ar < 1) delta *= ar; return delta; }
    function correctDeltaY(delta: number) { let ar = canvas.width / canvas.height; if (ar > 1) delta /= ar; return delta; }
    ...
    function handleTouchEnd(e: TouchEvent) {
      ...
      for (let i = 0; i < touches.length; i++) updatePointerUpData(pointers[0]);
    }
